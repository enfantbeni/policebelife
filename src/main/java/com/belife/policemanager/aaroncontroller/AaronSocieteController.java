...
@Controller
public class AaronSocieteController {
    ...
    AgenceRepository agenceRepository;
	 ...
	 @Transactional
	 @RequestMapping(value = {"/aaronGestionSociete" }, method = RequestMethod.GET)
...
//			gestion Menu 
	 ...
	 @Transactional
		@RequestMapping(value = "/aaronListeSocietes")
...
//	 @Transactional
	 @RequestMapping(value = {"/aaronResultatRechercheSociete" }, method = RequestMethod.POST)
...
//			gestion Menu 
	 ...
	 @Transactional
	 @RequestMapping(value = {"/aaronMessageSocieteNonExistante" }, method = RequestMethod.GET)
