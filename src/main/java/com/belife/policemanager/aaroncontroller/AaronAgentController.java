...
@Controller
public class AaronAgentController {
	...
	@Transactional
	@RequestMapping(value = { "/aaronGestionAgent" }, method = RequestMethod.GET)
...
//		gestion Menu 
	 ...
	 @Transactional
		@RequestMapping(value = "/aaronListeAgents")
...
//	 @Transactional
	 @RequestMapping(value = {"/aaronResultatRechercheAgent" }, method = RequestMethod.POST)
...
//			gestion Menu 
	 ...
	 @Transactional
	 @RequestMapping(value = {"/aaronMessageAgentNonExistant" }, method = RequestMethod.GET)
