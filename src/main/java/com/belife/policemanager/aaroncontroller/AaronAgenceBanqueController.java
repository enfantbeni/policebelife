...
@Controller
public class AaronAgenceBanqueController {
	 ...
	 @Transactional
	 @RequestMapping(value = {"/aaronGestionAgenceBanque" }, method = RequestMethod.GET)
...
//			gestion Menu 
		...
		@Transactional
		@RequestMapping(value = "/aaronAgenceBanque")
	    public ModelAndView listagenceBanquesPageByPage(@RequestParam(name="page", defaultValue="0") int page,@RequestParam(name="size", defaultValue="100") int size,  @ModelAttribute("agenceBanque") AgenceBanque agenceBanque, Model model, HttpSession session, HttpServletRequest request) {
		 ...
		 @Transactional
		 @RequestMapping(value = {"/aaronRechercheAgenceBanque" }, method = RequestMethod.GET)
...
//				gestion Menu 
		 ...
		 @Transactional
		 @RequestMapping(value = {"/aaronResultatRechercheAgenceBanque" }, method = RequestMethod.POST)
...
//				model.addAttribute("actionTroisBouton", "actionTroisBouton");	
		 ...
		 @Transactional
		 @RequestMapping(value = {"/aaronMessageAgenceBanqueNonExistante" }, method = RequestMethod.GET)
